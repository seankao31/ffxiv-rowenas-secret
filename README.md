...
Data is sourced from the [Universalis](https://universalis.app) API and refreshed automatically every 30 seconds.
...
Then open `http://localhost:3000` in your browser. The first scan takes about 25 seconds before results appear.
