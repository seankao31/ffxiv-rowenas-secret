...
- **Visual verification via Playwright MCP** (navigate + screenshot) before declaring work complete. Use `--isolated` when launching the browser — multiple Claude sessions may run Playwright concurrently.
